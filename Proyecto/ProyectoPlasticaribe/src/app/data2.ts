...
export class pasos {
  constructor(private invExtrusion : Inventario_ExtrusionComponent){}

  modalExtrusion = () => this.invExtrusion.datosOrden = true;
  ...
  stepAsignacionTintas: Step.StepOptions[] = [
    {
      attachTo: {
        element: '#intro',
        on: 'bottom-end'
  ...
  stepAsignacionBopp: Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario1',
        on: 'bottom-start'
  ...
  /*********************************************************** BODEGA EXTRUSIÓN **************************************************************************/
  stepsEliminarRollos : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsIngresoRollosExtrusion : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsInventarioExtrusion : Step.StepOptions[] = [
    {
      attachTo: {
  ...
  stepsMovimientosExtrusion : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsSalidaRollosExtrusion : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  /******************************************************************** DESPACHO ************************************************************************/
  stepsIngresoRolloDespacho : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsFacturarRolloDespacho : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsDespacharRollosDespacho : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsDevolverRolloDespacho : Step.StepOptions[]= [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsMovimientosDespacho : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsPreIngresoRolloDespacho : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  /************************************************************** DESPERDICIO ***********************************************************************/
  stepsDesperdicio : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  stepsReporteDesperdicio : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  /********************************************************* GESTIÓN DE ARCHIVOS *******************************************************************/
  stepsArchivos : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
  ...
  /**************************************************************** MATERIA PRIMA ******************************************************************/
  stepsAsignacionMateriaPrima : Step.StepOptions[] = [
    {
      attachTo: {
        element: '#formulario',
        on: 'bottom'
