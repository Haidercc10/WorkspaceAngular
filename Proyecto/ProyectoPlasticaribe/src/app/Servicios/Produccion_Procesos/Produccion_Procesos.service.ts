...
export class Produccion_ProcesosService {
  ...
  putAvailableFromReposition = (repo: number, user : number) => this.http.put<any>(`${this.rutaPlasticaribeAPI}/Produccion_Procesos/putAvailableFromReposition/${repo}/${user}`, repo);
