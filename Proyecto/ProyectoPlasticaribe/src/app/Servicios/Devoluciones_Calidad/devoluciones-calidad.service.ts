...
export class DevolucionesCalidadService {
  ...
  readonly rutaPlasticaribeAPI = environment.rutaPlasticaribeAPI;
    ...
    getTotalMoneyForMonth = (year : any, url? : any) => this.http.get<any>(this.rutaPlasticaribeAPI + `/Devoluciones_Calidad/getTotalMoneyForMonth/${year}${url}`);
    ...
    getDevolutionsForRejectedType = (year : any, url : string) => this.http.get<any>(this.rutaPlasticaribeAPI + `/Devoluciones_Calidad/getDevolutionsForRejectedType/${year}${url}`);
