...
//Metodo buscar lista de Usuario
  srvObtenerListaUsuario():Observable<any[]> {
      return this.httpUsuario.get<any>(this.rutaPlasticaribeAPI + '/Usuario')
  }
//Metodo agregar Usuario
  srvAgregarUsuario(data:any) {
    return this.httpUsuario.post(this.rutaPlasticaribeAPI + '/Usuario', data)
  }
//Metodo actualzar Usuario
  srvActualizarUsuario(id:number|String, data:any) {
    return this.httpUsuario.put(this.rutaPlasticaribeAPI + `/Usuario/${id}`, data);
  }
//Metodo eliminar Usuario
  srvEliminarUsuario(id:number|String) {
    return this.httpUsuario.delete(this.rutaPlasticaribeAPI + `/Usuario/${id}`);
  }

  srvGuardarUsuario(Usuario : modelUsuario): Observable<any> {
   return this.httpUsuario.post(this.rutaPlasticaribeAPI + '/Usuario', Usuario)
 }
