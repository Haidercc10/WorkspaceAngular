...
export class ExistenciasProductosService {
  ...
  GetStockProducts_AvaibleProduction = (sales? : string | null): Observable<any> => this.http.get<any>(`${this.rutaPlasticaribeAPI}/Existencia_Productos/getStockProducts_AvaibleProduction${sales}`);
  ...
  getInventoryProducts = (data : any): Observable<any> => this.http.post(this.rutaPlasticaribeAPI + '/Existencia_Productos/getInventoryProducts', data);
}
