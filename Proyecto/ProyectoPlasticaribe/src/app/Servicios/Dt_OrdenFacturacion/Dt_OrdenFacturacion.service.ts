...
export class Dt_OrdenFacturacionService {
    ...
    GetInformacionOrderFactAsync = (id: number) => this.http.get<any>(`${this.rutaPlasticaribeAPI}/Detalles_OrdenFacturacion/getInformationOrderFactAsync/${id}`);
    ...
    getDetailsForItem = (item: any) => this.http.get<any>(`${this.rutaPlasticaribeAPI}/Detalles_OrdenFacturacion/getDetailsForItem/${item}`);
