...
constructor(private http : HttpClient) { }
  ...
  Put = (id : any, data : any) => this.http.put(this.rutaPlasticaribeAPI + `/Precargue_Despacho/${id}`, data);

  putPreloadDispatch = (id : any, data : any) => this.http.put<any>(this.rutaPlasticaribeAPI + `/Precargue_Despacho/putPreloadDispatch/${id}`, data);
