...
export class DtPreEntregaRollosService {
  ...
  GetInformactionAboutPreInToSendDesp_ById = (id: number, item: number): Observable<any> => this.http.get<any>(`${this.rutaPlasticaribeAPI}/DetallePreEntrega_RolloDespacho/getInformactionAboutPreInToSendDesp_ById/${id}/${item}`);
