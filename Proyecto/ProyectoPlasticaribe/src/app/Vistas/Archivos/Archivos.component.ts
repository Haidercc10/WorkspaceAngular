...
export class ArchivosComponent implements OnInit {
  ...
  validarArchivo_Carpeta: boolean = false; //Variable que va a validar si lo que se quiere mover o copiar es un archivo o una carpeta
