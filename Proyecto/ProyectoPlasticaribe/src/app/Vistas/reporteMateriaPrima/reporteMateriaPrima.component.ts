...
export class ReporteMateriaPrimaComponent implements OnInit {
  ...
  cargarTabla(data: any) {
    if (![2001, 2072, 84, 88, 89].includes(data.id)) {
      ...
      if ([1,3,12,85,98].includes(this.ValidarRol)) this.ArrayMateriaPrima.push(info);
      this.ArrayMateriaPrima.sort((a, b) => a.Nombre.localeCompare(b.Nombre));

      if (this.categoriasMP.includes(data.categoria_Id) && ([1,3,12,85,98].includes(this.ValidarRol))) {
      ...
      if (this.categoriasTintas.includes(data.categoria_Id) && ([1,3,12,85,98].includes(this.ValidarRol))) {
      ...
      if (this.categoriasBOPP.includes(data.categoria_Id) && ([1,3,4,89,63,12,85,98].includes(this.ValidarRol))) {
