...
export class ReporteProduccionComponent implements OnInit {
  ...
  validarProcesoPorUsuarioRegistrado() {
    if (![1, 10, 83, 12, 2, 5, 7, 85, 98, 103, 104, 105, 3].includes(this.ValidarRol)) {
        ...
        table: {
          ...
          body: [
            [
              ...
              { text: proceso == 'SELLADO' || proceso == 'Wiketiado' || proceso == 'CAMISILLA' ? `Teorico` : `P. Bruto`, alignment: 'center', bold: true, border: [false, false, false, false] },
              { text: proceso == 'SELLADO' || proceso == 'Wiketiado' || proceso == 'CAMISILLA' ? `P. Neto` : `P. Neto`, alignment: 'center', bold: true, border: [false, false, false, false] },
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: ['SELLADO', 'Wiketiado', 'CAMISILLA'].includes(items.proceso) ? `${this.formatonumeros(items.cantidad)}` : `${this.formatonumeros(items.peso)}`, alignment: 'center', border: [false, false, false, false], },
            ...
            { text: ['SELLADO', 'Wiketiado', 'CAMISILLA'].includes(items.proceso) ? `${this.formatonumeros(items.pesoTeorico)}` : `${this.formatonumeros(items.cantidad)}`, alignment: 'center', border: [false, false, false, false], },
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: ['SELLADO', 'Wiketiado', 'CAMISILLA'].includes(data.proceso) ? `${this.formatonumeros(this.totalQty(data.orden).toFixed(2))}` : `${this.formatonumeros(this.totalWeightReal(data.orden).toFixed(2))}`, alignment: 'center', bold: true, border: [false, true, false, false], },
            { text: ``, alignment: 'center', border: [false, false, false, false], },
            { text: ``, alignment: 'center', border: [false, false, false, false], },
            { text: ['SELLADO', 'Wiketiado', 'CAMISILLA'].includes(data.proceso) ? `${this.formatonumeros(this.totalWeightTeoric(data.orden).toFixed(2))}` : `${this.formatonumeros(this.totalWeight(data.orden).toFixed(2))}`, alignment: 'center', bold: true, border: [false, true, false, false], },
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: ``, alignment: 'center', border: [false, false, false, false], },
            { text: ``, alignment: 'center', border: [false, false, false, false], },
            { text: ['SELLADO', 'Wiketiado', 'CAMISILLA'].includes(data[data.length - 1].proceso) ? `${this.formatonumeros(this.totalFinalTeoricWeight(data).toFixed(2))}` : `${this.formatonumeros(this.totalFinalGrossWeight(data).toFixed(2))}`, alignment: 'center', bold: true, border: [false, false, false, true], },
            { text: ``, alignment: 'center', border: [false, false, false, false], },
