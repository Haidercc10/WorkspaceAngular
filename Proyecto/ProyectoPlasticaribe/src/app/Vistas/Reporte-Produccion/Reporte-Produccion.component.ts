...
export class ReporteProduccionComponent implements OnInit {
  ...
  validarProcesoPorUsuarioRegistrado() {
    if (![1, 10, 83, 12, 2, 5, 7, 85, 98].includes(this.ValidarRol)) {
      ...
      if ([63,89,76,77].includes(this.ValidarRol)) this.areasEmpresa = ['ROTOGRABADO', 'LAMINADO', 'EXTRUSION', 'IMPRESION', 'SELLADO', 'CAMISILLA'];
        ...
        table: {
          ...
          body: [
            [
              ...
              { text: proceso == 'SELLADO' || proceso == 'Wiketiado' ? `Teorico` : `P. Bruto`, alignment: 'center', bold: true, border: [false, false, false, false] },
              { text: proceso == 'SELLADO' || proceso == 'Wiketiado' ? `P. Real` : `P. Neto`, alignment: 'center', bold: true, border: [false, false, false, false] },
