  ...
  llenarDetallesPedidosZeus(datos : any){
    for (let i = 0; i < this.ArrayDocumento.length; i++) {
      if (this.ArrayDocumento[i].data.consecutivo == datos.consecutivo) {
        ...
        this.columnas = [
          { header: 'Pedido', field: 'consecutivo', tamano: 'width: 150px' },
          { header: 'Cliente', field: 'cliente', tamano: 'width: 200px' },
          { header: 'Producto', field: 'producto', tamano: 'width: 200px' },
          { header: 'Cant. Pedida', field: 'cant_Pedida', tamano: 'width: 150px' },
          { header: 'Pendiente', field: 'cant_Pendiente', tamano: 'width: 150px' },
          { header: 'Facturada', field: 'cant_Facturada', tamano: 'width: 150px' },
          { header: 'Stock', field: 'existencias', tamano: 'width: 100px' },
          { header: 'Und', field: 'presentacion', tamano: 'width: 100px' },
          { header: 'Estado', field: 'estado', tamano: 'width: 200px' },
          { header: 'Vendedor', field: 'vendedor', tamano: 'width: 200px' },
          { header: 'OT', field: 'OT', tamano: 'width: 100px' },
          { header: 'Proceso Actual', field: 'Proceso_OT', tamano: 'width: 300px' },
          { header: 'Total Pendiente', field: 'costo_Cant_Pendiente', tamano: 'width: 200px' },
          { header: 'Total', field: 'costo_Cant_Total', tamano: 'width: 150px' },
          { header: 'Precio U.', field: 'precioUnidad', tamano: 'width: 200px' },
          { header: 'OC Cliente', field: 'orden_Compra_CLiente', tamano: 'width: 200px' },
          { header: 'Fecha Creación', field: 'fecha_Creacion', tamano: 'width: 200px' },
          { header: 'Fecha Entrega', field: 'fecha_Entrega', tamano: 'width: 200px' },
        ];
