...
export class PruebaImagenCatInsumoComponent implements OnInit {
  ...
  consultarVendedores = () => this.usuarioService.GetVendedores().subscribe(data => this.vendedores = data);
      ...
      this.ordenTrabajoService.GetInfoUltOT(this.producto, this.presentacionProducto).subscribe(datos_Ot => {
        ...
        this.bagProService.srvObtenerListaClienteOT_Item_Presentacion(this.producto, presentacion).subscribe(datos_Ot => {
          for (const itemOt of datos_Ot) {
            ...
            itemOt.corte.trim() == '1' ? this.corte = true : this.corte = false;
            itemOt.cyrel.trim() == '1' ? this.cyrel = true : this.cyrel = false;
  ...
  cambiarEstadoCliente(cliente : number){
    this.clienteServise.PutEstadoCliente(cliente, 1).subscribe(null, error => this.msj.mensajeError(`No fue posible actualizar el estado del cliente con el Id ${cliente}`, error.error));
  }
    ...
    this.ordenTrabajoService.GetOrdenTrabajo(numeroOT).subscribe(datos_orden => {
      for (let i = 0; i < datos_orden.length; i++) {
        ...
        this.FormOrdenTrabajo.patchValue({
          ...
          Nombre_Cliente: datos_orden[i].id_Cliente,
                    ...
                    table : {
                      ...
                      body : [
                        ...
                        [
                          ...
                          { border : [], text : `${datos_ot[i].m1C1_nombre == 'NO APLICA MATERIAL' ? 'N/A' : datos_ot[i].m1C1_nombre.toString().trim()}`, margin: [0, 2]},
                        ...
                        [
                          ...
                          { border : [], text : `${datos_ot[i].m2C1_nombre == 'NO APLICA MATERIAL' ? 'N/A' : datos_ot[i].m2C1_nombre.toString().trim()}`, margin: [0, 2]},
                        ...
                        [
                          ...
                          { border : [], text : `${datos_ot[i].m3C1_nombre == 'NO APLICA MATERIAL' ? 'N/A' : datos_ot[i].m3C1_nombre.toString().trim()}`, margin: [0, 2]},
                        ...
                        [
                          ...
                          { border : [], text : `${datos_ot[i].m4C1_nombre == 'NO APLICA MATERIAL' ? 'N/A' : datos_ot[i].m4C1_nombre.toString().trim()}`, margin: [0, 2]},
                        ...
                        [
                          ...
                          { border : [], text : `${datos_ot[i].p1C1_Nombre == 'NO APLICA PIGMENTO' ? 'N/A' : datos_ot[i].p1C1_Nombre.replace('PIGMENTO', 'PIG.').toString().trim()}`, margin: [0, 2]},
                        ...
                        [
                          ...
                          { border : [false, false, false, true], text : `${datos_ot[i].p2C1_Nombre == 'NO APLICA PIGMENTO' ? 'N/A' : datos_ot[i].p2C1_Nombre.replace('PIGMENTO', 'PIG.').toString().trim()}`, margin: [0, 2]},
