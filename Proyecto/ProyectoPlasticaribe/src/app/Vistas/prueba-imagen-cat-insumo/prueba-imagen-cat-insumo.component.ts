...
export class PruebaImagenCatInsumoComponent implements OnInit  {
  ...
  visibilidadSeleccionable: any[] = [{ key: `A`, label: `Solo Yo`, data: `Solo Yo`, icon: 'pi pi-fw pi-user', children: [] }];
  visibilidadSeleccionada: any;
