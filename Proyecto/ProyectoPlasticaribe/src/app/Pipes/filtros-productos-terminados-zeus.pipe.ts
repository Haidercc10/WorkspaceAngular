...
@Pipe({
  name: 'filtrosProductosTerminadosZeus'
})
export class FiltrosProductosTerminadosZeusPipe implements PipeTransform {
  ...
  transform(value: any, arg: any): any {
    ...
    for(const prodZeus of value) {
      ...
      if(prodZeus.nombreItem.toUpperCase().indexOf(arg.toUpperCase()) > -1) {
