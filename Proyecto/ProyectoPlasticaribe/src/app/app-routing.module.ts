...
export const routes: Routes = [
  ...
  { path: 'mov-reposiciones', loadChildren: () => import('./Modules/mov-reposiciones/mov-reposiciones.module').then(m => m.MovReposicionesModule) },
  ...
  { path: 'trazabilidad-produccion', loadChildren: () => import('./Modules/reporte-trazabilidad-produccion/reporte-trazabilidad-produccion-routing.module').then(m => m.ReporteTrazabilidadProduccionRoutingModule) },
  ...
  { path: 'solicitud-rollos-areas', loadChildren: () => import('./Modules/solicitud-rollos-areas/solicitud-rollos-areas.module').then(m => m.SolicitudRollosAreasModule) },
  ...
  { path: 'mov-devoluciones-calidad', loadChildren: () => import('./Modules/mov-devoluciones-calidad/mov-devoluciones-calidad.module').then(m => m.MovDevolucionesCalidadModule) },  
]
